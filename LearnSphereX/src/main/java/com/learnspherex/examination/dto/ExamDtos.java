...
public final class ExamDtos {
 ...
 public record CreateQuestionRequest(@NotBlank String questionText,@NotBlank String questionType,@NotNull BigDecimal marks,@Min(1) Integer questionOrder,List<OptionRequest> options,String expectedAnswer,String constraints){}
